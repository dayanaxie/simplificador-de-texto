...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] flex flex-col">
        ...
        <div className="bg-white border border-[#E0E0E0] w-full p-5 sm:p-8 lg:p-10 flex flex-col gap-6 sm:gap-8">
          ...
          <section className="flex flex-col gap-5 sm:gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea ref={inputTextareaRef}
                ...
                placeholder="Ingrese el texto original" value={inputText}
          ...
          <section className="flex flex-col gap-5 sm:gap-6">
            ...
            <div className="flex flex-wrap gap-3 justify-end">
              <button type="button" onClick={handleOpenReportModal} disabled={!simplifiedText}
      ...
      {/* Modal de reporte — sin cambios */}
      {isReportModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50"
          onClick={handleCancelReport}>
          <div className="bg-white w-full max-w-[460px] mx-4 p-6 shadow-lg rounded"
            onClick={(e) => e.stopPropagation()}>
            <h2 className="font-inter font-semibold text-xl text-black mb-5">
              Ingrese el motivo del reporte
            </h2>
            <div className="flex flex-col gap-1.5">
              <label className="font-inter font-normal text-base text-[#1E1E1E]">Descripción</label>
            ...
            <div className="flex justify-end gap-3 mt-6">
              ...
              <button type="button" onClick={handleSendReport} disabled={!reportDescription.trim()}
