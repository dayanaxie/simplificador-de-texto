...
const FunnelIcon = () => (
  ...
  >
    <path
      d="M0 0L10.5 13.2692V20.3462L17.5 23V13.2692L28 0H0Z"
      fill="white"
    />
  </svg>
);
        ...
        <div className="bg-white border border-[#E0E0E0] w-full">
          ...
          <div className="p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-2 bg-[#F5F5F5] h-[60px] px-4 min-w-[200px] sm:w-[290px]">
              <SearchIcon />
              <span className="font-roboto text-base text-[#49454F] leading-6 tracking-[0.5px]">
                Fecha de inicio
              </span>
            </div>
            ...
            {/* Filter Button */}
            <button className="h-[33px] px-6 bg-[#002855] text-white font-inter text-sm font-medium leading-[150%] hover:bg-[#001e42] transition-colors">
              Filtrar
            </button>
          </div>
          ...
          {/* Export Button */}
          <div className="px-6 sm:px-8 pb-10 flex justify-center">
            <button className="h-[33px] px-6 bg-[#002855] text-white font-inter text-sm font-medium leading-[150%] hover:bg-[#001e42] transition-colors">
              Exportar
            </button>
          </div>
